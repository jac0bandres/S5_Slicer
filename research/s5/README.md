...
Archived research implementation. The current S³ project is at the
[repository root](../../README.md). Run the commands below from this `research/s5`
directory; the S4 reference used here is under `../s4/`.
...
```bash
git clone <this-repo> && cd S5_Slicer/research/s5
